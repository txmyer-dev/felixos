  ...
  test.beforeAll(async () => {
    ...
    execSync('pnpm db:seed', {
      ...
      env: {
        ...
        DATABASE_PRIVILEGED_URL: 'postgresql://felixos_privileged:6f28eabf0517a84c892039028e0504c4@127.0.0.1:5434/felixos',
        TOTP_SECRET_ENCRYPTION_KEY: '2447147e34ecbe69160a5ddaebebe8c1ecf0db824e9753ac12d4dde60b87b82e'
      }
    });
  });
