...
_Note: Make sure `HOST_DB_PORT` is exposed if running this command from the host._
...
_Note: Database migrations are generally not automatically rolled back. If a breaking schema change was introduced, you may need to restore from a backup._
